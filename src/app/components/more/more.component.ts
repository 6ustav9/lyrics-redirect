...
export class MoreComponent {
    ...
    project_version_links = [
        ...
        //     description: "Angular 11 com CSS3 - Disponibilizado por Heroku"    // Atualizar para a Vercel
        // },
        {
            ...
            description: "Angular 14 com SASS, consumindo Json Server - Disponibilizado por Vercel"
        }
